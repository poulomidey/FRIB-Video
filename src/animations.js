...
function choose_pos(nucleus, flash)
{    
...
function break_nucleus(nucleus)
{
    // if( Math.random() < .5)
    // {
        replace_nucleus(nucleus, radius, Math.floor(.75 * nucleus.userData.proton), Math.floor(.75 * nucleus.userData.neutron), false)
    // }
}
